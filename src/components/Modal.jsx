      ...
      <div className="relative p-4 w-full max-w-2xl max-h-full">
        <div className="relative bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center justify-between p-4 md:p-5 border-b border-gray-200 rounded-t">
            ...
            <button
              className="text-gray-500 hover:bg-gray-100 hover:text-black rounded-lg text-sm w-8 h-8 inline-flex justify-center items-center cursor-pointer"
              type="button"
              onClick={onClose}
            >
              <svg
          ...
          <div className="p-4 md:p-5 space-y-4 text-black">{children}</div>
        </div>
      </div>
    </div>
  );
